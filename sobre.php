...
<body>
    <nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
      ...
      <br><br>
    <h1><b>Sobre</b></h1><br><br>
    <form action="" method="POST">
    <div id="wrap">
        <div>    
            <p>Mussum Ipsum, cacilds vidis litro abertis.  Atirei o pau no gatis, per gatis num morreus. <br>Praesent vel viverra nisi. <br>Mauris aliquet nunc non turpis scelerisque, eget. Todo mundo vê os porris que eu tomo, mas ninguém vê os tombis que eu levo! <br>Vehicula non. Ut sed ex eros. <br>Vivamus sit amet nibh non tellus tristique interdum.</p>
        </div>
        <div>
    ...
    <br>
    <footer class="rodapé bg-dark m-auto">
