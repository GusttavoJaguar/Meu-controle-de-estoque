<?php
	...
	if(isset($_POST['submit']))
		{	
			...
			$result = mysqli_query($conexao, "INSERT INTO usuários(nome, senha, email, telefone) VALUES ('$nome', '$senha', '$email', '$telefone')");
    ...
    <div>
	    <form action="caduser.php" method="POST">>	
	       <legend><b>Cadastro de usuários</b></legend>
	        <br><br>
	            <div class="inputBox">
	                <input type="text" name="nome" id="nome" class="inputUser" placeholder="Nome usuário" required>
